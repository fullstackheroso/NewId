...
namespace MassTransit.NewIdFormatters
{
        ...
        INewIdFormatter
    {
        ...
        private static readonly ThreadLocal<char[]> _formatBuffer  = new ThreadLocal<char[]>(() => new char[26]);

        private readonly string _chars;

        public Base32Formatter(bool upperCase = false) => _chars = upperCase ? UpperCaseChars : LowerCaseChars;
